...
class KFWProxy {
    ...
    async latestVersion(id, affiliate = "kobo") {
        ...
        if (id == "00000000-0000-0000-0000-000000000390")
            version = "4.42.23296" // required to receive the next update (4.42.23296 -> 4.43.23418)
        if (id == "00000000-0000-0000-0000-000000000391")
            version = "4.42.23296" // required to receive the next update (4.42.23296 -> 4.43.23418)
        if (id == "00000000-0000-0000-0000-000000000393")
            version = "4.42.23296" // required to receive the next update (4.42.23296 -> 4.43.23418)
...
class KoboFirmware {
    ...
    constructor(
        ...
        devices = [
            ...
            ["kobo12", "00000000-0000-0000-0000-000000000391", "Kobo Clara BW (N365)"],
            ["kobo12", "00000000-0000-0000-0000-000000000393", "Kobo Clara Colour"],
            ["kobo14", "00000000-0000-0000-0000-000000000395", "Kobo Clara BW (P365)"],
