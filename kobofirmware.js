...
function getVersions() {
    ...
    return Promise.all(devices.map(function (device) {
        ...
        document.querySelector(".bbcode-text").innerHTML = [
            ...
            '\n[/LIST]\n\n',
            '[SIZE=1]',
            'Generated by [URL=https://pgaskin.net/KoboStuff/kobofirmware.html]kobofirmware[/URL] ',
            'by [URL=https://github.com/pgaskin]Patrick Gaskin (geek1011)[/URL]. ',
            '[URL=https://github.com/pgaskin/KoboStuff/blob/gh-pages/kobofirmware.html]Source Code[/URL]',
            '[/SIZE]'
        ].join("");
